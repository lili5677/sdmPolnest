            ...
            <form method="POST" action="">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?= $_POST['tanggal_lahir'] ?? '' ?>" required>
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_mulai_kerja" name="tanggal_mulai_kerja" value="<?= $_POST['tanggal_mulai_kerja'] ?? '' ?>" required>
                    </div>
                    ...
                    <div id="kontrakFields" style="display: <?= ($_POST['jenis_kepegawaian'] ?? '') == 'kontrak' ? 'block' : 'none' ?>;">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control kontrak-required" id="masa_kontrak_mulai" name="masa_kontrak_mulai" value="<?= $_POST['masa_kontrak_mulai'] ?? '' ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="masa_kontrak_selesai" class="form-label">
                                    Masa Kontrak Selesai <span class="required">*</span>
                                </label>
                                <input type="date" class="form-control kontrak-required" id="masa_kontrak_selesai" name="masa_kontrak_selesai" value="<?= $_POST['masa_kontrak_selesai'] ?? '' ?>">
                            </div>
                        </div>
                    </div>
                </div>
